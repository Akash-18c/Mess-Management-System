...
import { LayoutDashboard, UtensilsCrossed, ShoppingCart, CreditCard, FileText, LogOut, Menu, Receipt, Bike, HandCoins } from 'lucide-react';
...
const links = [
  ...
  { to: '/manager/borrows', icon: HandCoins, label: 'Borrows' },
];
