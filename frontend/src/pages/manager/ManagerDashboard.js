                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0 ml-2">
                      ...
                      {o.hasData && !o.isClosed && !o.isCurrent && <span style={{ fontSize: '8px', background: 'rgba(52,211,153,0.12)', color: '#6ee7b7', border: '1px solid rgba(52,211,153,0.25)', padding: '2px 5px', borderRadius: '999px' }}>Open</span>}
                      )}
                    </div>
                  </button>
                );
