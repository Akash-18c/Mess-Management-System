          ...
          <div className="relative rounded-[28px] sm:rounded-[32px] overflow-hidden"
            ...
            <div className="px-5 sm:px-7 py-5 sm:py-6 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                {/* Google Sign In — custom visual + real SDK button on top */}
                <div className="relative w-full rounded-2xl overflow-hidden" style={{ height: 46 }}>
                  {/* Visual layer */}
                  ...
                  {/* Real SDK button — invisible but fully clickable on top */}
                  <div ref={googleBtnRef} className="absolute inset-0" style={{ opacity: 0.001 }} />
                </div>
