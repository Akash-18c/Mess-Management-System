          ...
          <div className="relative rounded-[28px] sm:rounded-[32px] overflow-hidden"
            ...
            <div className="px-5 sm:px-7 py-5 sm:py-6 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                {/* Google Sign In — SDK renders real button, custom skin on top */}
                <div className="relative w-full" style={{ height: 46 }}>
                  {/* Real SDK button — visible and clickable, fills container */}
                  <div ref={googleBtnRef}
                    style={{ position: 'absolute', inset: 0, overflow: 'hidden', borderRadius: 16, opacity: googleReady ? 1 : 0 }}
                  />
                  {/* Custom visual skin — pointer-events-none so clicks pass through to SDK */}
                  {googleReady && (
                    <div className="absolute inset-0 flex items-center justify-center gap-3 pointer-events-none rounded-2xl"
                      style={{ background: 'rgba(255,255,255,0.95)', border: '1px solid rgba(255,255,255,0.60)', boxShadow: '0 2px 16px rgba(0,0,0,0.12)' }}>
                  ...
                  {/* Loading state before SDK ready */}
                  {!googleReady && (
                    <div className="absolute inset-0 flex items-center justify-center rounded-2xl"
                      style={{ background: 'rgba(255,255,255,0.50)', border: '1px solid rgba(255,255,255,0.30)' }}>
                      <span className="text-sm" style={{ color: 'rgba(255,255,255,0.60)' }}>Loading…</span>
                    </div>
                  )}
                </div>
